        ...
        <footer>
            <div className="footer-up">
                <div>
                    ...
                    <p>BestOnlineDealz is an awesome website to get the best deals and offers. Here we share the cheapest deals and discount offers that help you to save money on shopping. Always check deals here before you want to buy online.</p>
                </div>
                <div>
                    <h2>Imp Links</h2>
